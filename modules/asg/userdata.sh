...
mysql -u ${mysql_user} -p${mysql_pass} -h "$x" -e "CREATE DATABASE drupal1; CREATE USER '${db_user}' IDENTIFIED BY '${db_pass}'; GRANT ALL PRIVILEGES ON drupal1.* TO '${db_user}'; FLUSH PRIVILEGES;"
